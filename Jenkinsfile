...
pipeline {
    ...
    stages {
        ...
        stage('Build reference-ui') {
            ...
            steps {
                sh "docker tag openlmis/one-network-integration-ui:latest openlmis/one-network-integration-ui:${VERSION}"
                sh "docker push openlmis/one-network-integration-ui:${VERSION}"
